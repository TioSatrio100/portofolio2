...
const PortfolioSection: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black py-16 px-8" id="portfolio">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <span className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-700 via-purple-600 to-blue-600 bg-clip-text text-transparent animate-pulse mb-4">My Work Portfolio</span>
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">Explore my diverse portfolio across different domains</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioItems.map((item) => (
            <div key={item.id} className="group">
              <div className="bg-gradient-to-br from-black-200 via-white-100 to-white-500 rounded-3xl p-8 border border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full flex flex-col">
                {/* Illustration */}
                ...
                <div className="flex-grow">
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-gray-700 via-purple-600 to-purple-600 bg-clip-text text-transparent mb-4">{item.title}</h3>
                  <p className="text-white-600 leading-relaxed mb-8">{item.description}</p>
                </div>

                {/* Buttons */}
                <div className="space-y-3">
                  <div className="flex gap-3">
                    <a href={item.githubUrl} className="flex-1 bg-black hover:bg-slate-700 text-white py-3 px-4 rounded-xl font-medium border border-white transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105">
                    ...
                    <a href={item.projectUrl} className="flex-1 bg-purple-600 hover:bg-purple-300 text-white py-3 px-4 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105">
        ...
        <div className="text-center mt-16">
          <p className="text-white-600 text-lg mb-6">Want to see more projects?</p>

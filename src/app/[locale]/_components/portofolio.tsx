...
const portfolioData: RawPortfolioItem[] = [
  {
    id: 1,
    translationKey: "glowsync",
    techStack: [<NextJSIcon key="next" />, <TailwindIcon key="tw" />, <SupabaseIcon key="sb" />],
  ...
  {
    id: 2,
    translationKey: "photobooth",
    techStack: [<NextJSIcon key="next" />, <TailwindIcon key="tw" />],
  ...
  {
    id: 3,
    translationKey: "efishery",
    techStack: [<PythonIcon key="py" />, <TensorFlowIcon key="tf" />],
    ...
    <div className="min-h-screen bg-white py-20 px-6 relative overflow-hidden" id="portfolio">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-16">
          <h2 className="text-5xl lg:text-6xl font-black uppercase mb-6">
            <motion.span
              ...
              className={`${pixelify.className} bg-purple-400 px-6 py-3 text-black inline-block border-4 border-black transform -rotate-1 shadow-lg mr-2`}
            >
              {t("titleWord1")}
            </motion.span>
            <motion.span
              ...
              animate={isInView ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.6, ease: "easeOut" }}
              className={`${pixelify.className} bg-yellow-400 px-6 py-3 text-black inline-block border-4 border-black transform -rotate-1 shadow-lg`}
            >
              {t("titleWord2")}
            </motion.span>
          </h2>
            ...
            <div key={item.id} className="group">
              <div className="bg-gray-100 border-4 border-black overflow-hidden transform hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl h-full flex flex-col">
                ...
                <div className="relative w-full h-56 bg-white border-b-4 border-black overflow-hidden group-hover:scale-105 transition-transform duration-300">
                  <Image
                    src={item.imageUrl}
                    alt={t(`items.${item.translationKey}.title`)}
                    fill
                ...
                <div className="p-6 flex-grow flex flex-col bg-white">
                  ...
                  <div className="flex gap-4 mb-4">
                    {item.techStack.map((techIcon, idx) => (
                      <div key={idx}>{techIcon}</div>
                    ))}
                  </div>
        ...
        <div className="text-center mt-16">
          <p className="text-black text-xl font-bold mb-6">{t("moreProjectsQuestion")}</p>
